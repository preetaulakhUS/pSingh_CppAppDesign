# pSingh_CppAppDesign
The C++ application planned to be designed herein will have been authored by Preetinder Singh for class project and assignment purposes. Miscellaneous 'modules' folders, from 02 to 15, and their respective readme.md files, all empty, have been hid for the sake of brevity (read .gitignore).

Information:-<br>
Authored by: Preetinder Singh<br>
Course:      CIS 25, Laney College<br>
Date:        08/24/2026<br>
IDE:         VSCode<br>
App Name:    Account Nexus
