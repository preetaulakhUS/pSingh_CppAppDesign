# pSingh_CppAppDesign
The C++ application planned to be designed herein will have been authored by Preetinder Singh for class project and assignment purposes. Miscellaneous 'modules' folders, from 02 to 15, and their respective readme.md files, all empty, have been hid for the sake of brevity (read .gitignore).<br>
